...
const (
	...
	IPCModeContainer IpcMode = "container" //nolint:unused // was used to match prefix, but we could consider removing, as it's not a literal value
